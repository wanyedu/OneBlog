...
<#--        ${config.webCssCdn!}-->
<#--    <#else >-->
<#--        <link href="${config.staticWebSite}/css/font-awesome.min.css" rel="stylesheet" type="text/css">-->
<#--        <link href="${config.staticWebSite}/css/bootstrap.min.css" rel="stylesheet">-->
<#--        <link href="${config.staticWebSite}/css/jquery-confirm.min.css" rel="stylesheet">-->
<#--        <link href="${config.staticWebSite}/css/jquery.fancybox.min.css" rel="stylesheet">-->
<#--        <link href="${config.staticWebSite}/css/bootstrapValidator.min.css" rel="stylesheet">-->
<#--        <link href="${config.staticWebSite}/css/nprogress.min.css" rel="stylesheet">-->
<#--    </#if>-->
<#--    <link href="${config.staticWebSite}/css/zhyd.core.css" rel="stylesheet" type="text/css">-->
<#--    <link href="${config.staticWebSite}/css/zhyd.comment.css" rel="stylesheet" type="text/css">-->
